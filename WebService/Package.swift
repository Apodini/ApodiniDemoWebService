...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "JassDeploymentProvider", url: "https://github.com/JASS-2021/JassDeploymentProviderValidation.git", .branch("trunk")),
    ...
    targets: [
        ...
        .executableTarget(
            ...
            dependencies: [
                ...
                .product(name: "LifxIoTDeploymentOption", package: "JassDeploymentProvider"),
                .product(name: "DuckieIoTDeploymentOption", package: "JassDeploymentProvider")
            ]),
        .testTarget(
